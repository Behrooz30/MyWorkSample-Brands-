...
- Also in BrandCRUDController ,where we used *imageTask.ResizeWidth(150)* mthod , if our picture was not in a suitable format ,we will get an error. For controlling this error , I include this code in try-catch block , and in catch was returns NotFound() code that is same 404 error. I could returns other error number , and this number is used contractual , this was because I wanted it to be understandable and recognizable for our javascript code in view.
...
- GleamTech.ImageUltimate : Version 5.6.1
