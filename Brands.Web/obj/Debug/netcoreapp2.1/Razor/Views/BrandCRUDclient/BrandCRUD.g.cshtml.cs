#pragma checksum "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c34c89d6083eb3613360edaf18f7b288a3525795"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c34c89d6083eb3613360edaf18f7b288a3525795", @"/Views/BrandCRUDclient/BrandCRUD.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "10cabe05ae684acc828c4e2b7ab9291e", async() => {
    ...
    ");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1985e7a338c24330a68444348e66326c", async() => {
...
function FetchAllBrandsFromBrandsTBL() {
 $.ajax({
            url: '");
                EndContext();
                BeginContext(3336, 15, false);
#line 122 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
...
#line hidden
            ...
            'Authorization': 'Bearer ");
                EndContext();
                BeginContext(3609, 16, false);
#line 129 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                                Write(Model.ToString());

#line default
#line hidden
                EndContext();
                BeginContext(3625, 3036, true);
                WriteLiteral(@"'
            },            
                ...
                if (result.length != 0) {
                    ...
                    for (i = 0; i < result.length; i++) {
                        ...
                        var append = ""<tr id='"" + result[i][""BrandId""] + ""' class='list_1_'>"" +
                            ...
                            ""<img id='test"" + brandid + ""' alt");
                WriteLiteral(@"='test' src='' height='70px'/>"" +
                      ...
                      ");
                WriteLiteral(@"      '""DeleteItem(' + ""'"" + brandid + ""'"" + ')"" id = ""AddButton"" class=""btn btn-danger btn-xs btn-block"" > ' +
                            ""Delete"" + '</button > ' +
                            '</td></tr></table>'
...
#line 202 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                              Write(MyDomain.Domain);
...
#line hidden
                ...
                EndContext();
                BeginContext(6825, 16, false);
#line 204 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                                                           Write(Model.ToString());

#line default
#line hidden
                EndContext();
                BeginContext(6841, 714, true);
                WriteLiteral(@"'};
...
#line 222 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                              Write(MyDomain.Domain);

#line default
#line hidden
                EndContext();
                BeginContext(7571, 147, true);
                WriteLiteral("\' + \'/api/BrandCRUD/GetPic/\'+ brandId,\r\n                ajaxOptions.type = \"GET\";\r\n                ajaxOptions.headers = {\'Authorization\': \'Bearer ");
                EndContext();
                BeginContext(7719, 16, false);
#line 224 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                                                           Write(Model.ToString());

#line default
#line hidden
                EndContext();
                BeginContext(7735, 5869, true);
                WriteLiteral(@"'};
            ajaxOptions.headers.Accept = ""application/octet-stream""
            ajaxOptions.success = function (result) {
                 if (result != undefined) {
            ...
            $(document).ready(function () {
                ...
                function ShowItemDetails(brandid) {
                    ...
                    $(document).ready(function () {
                        ...
                        document.getElementById('eng4Details'");
                WriteLiteral(@").innerHTML = EngText.textContent;
                        LoadOnePic4DialogBox(brandid);
        ...
        //this block cause to after cha");
                WriteLiteral(@"nging the picture , the picture is changed suddenly :
        ...
        $(""#dialog_Edit"").dialog({
          ...
          ");
                WriteLiteral(@"          var myUploader = $('input[name=""myUploader""]').val();
        ...
        function EditAnItem(PersianName4Edit, EnglishName4Edit) {
            ...
            $.ajax({
                url: '");
                EndContext();
                BeginContext(13605, 15, false);
#line 370 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                 Write(MyDomain.Domain);

#line default
#line hidden
                EndContext();
                BeginContext(13620, 137, true);
                WriteLiteral("\' + \'/api/BrandCRUD/EditBrand/\',\r\n                type: \"PUT\",\r\n                headers: {\r\n                    \'Authorization\': \'Bearer ");
                EndContext();
                BeginContext(13758, 16, false);
#line 373 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                                        Write(Model.ToString());

#line default
#line hidden
                EndContext();
                BeginContext(13774, 4067, true);
                WriteLiteral(@"'
                },
                dataType: ""json"",
                data: model,
                ...
                WriteLiteral(@"  '<button type=""button"" value=""Delete"" style=""height:50px; "" onclick=""DeleteItem(' + _brandId + ')"" id=' +
                        ...
                        //سطر قدیمی را پاک کردیم بعد آی دی اپند ر");
                WriteLiteral(@"ا تغییر دادیم و آندر لاین را از آخر آن
        ...
        function AddAnItem(PersianName4Add, EnglishName4Add) {
            ...
            $.ajax({
                url: '");
                EndContext();
                BeginContext(17842, 15, false);
#line 448 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                 Write(MyDomain.Domain);

#line default
#line hidden
                EndContext();
                BeginContext(17857, 170, true);
                WriteLiteral("\' + \'/api/BrandCRUD/AddBrand\',\r\n                type: \"Post\",\r\n                ///async: false,\r\n                headers: {\r\n                    \'Authorization\': \'Bearer ");
                EndContext();
                BeginContext(18028, 16, false);
#line 452 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                                        Write(Model.ToString());

#line default
#line hidden
                EndContext();
                BeginContext(18044, 2923, true);
                WriteLiteral(@"'
                },
                dataType: ""json"",
                data: model,
                ...
                success: function (data) {
                        ...
                        var append = ""<tr id='"" + data.BrandId + ""'>"" +
                            ...
                            ""<td>"" +
                            '<table><tr><td>' +
                            '<button type=""button"" value=""Edit"" style=""height:50px;");
       ...
       function DelAnItem(brandid) {
            ...
            $.ajax({
                url: '");
                EndContext();
                BeginContext(20968, 15, false);
#line 518 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                 Write(MyDomain.Domain);

#line default
#line hidden
                EndContext();
                BeginContext(20983, 142, true);
                WriteLiteral("\' + \'/api/BrandCRUD/DeleteBrand/\',\r\n                type: \"Delete\",\r\n                headers: {\r\n                    \'Authorization\': \'Bearer ");
                EndContext();
                BeginContext(21126, 16, false);
#line 521 "E:\Iman madaeni\MyGitProj4CV\Brands_2\Brands\Brands.Web\Views\BrandCRUDclient\BrandCRUD.cshtml"
                                        Write(Model.ToString());

#line default
#line hidden
                EndContext();
                BeginContext(21142, 2521, true);
                WriteLiteral(@"'
                },
                dataType: ""json"",
                data: model,
...
");
                WriteLiteral(@"                    AddAnItem(PersianName4Add, EnglishName4Add);
